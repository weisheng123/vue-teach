        ...
        rules:[                                         //所以针对不同类型的文件,我们定义不同的识别规则,最终目的都是打包成js文件
            {
                test: /\.vue$/,
                loader: 'vue-loader',
                options: creatVueLoaderOptions(isDev)                    //处理.vue文件
            },
            {
                test: /\.(vue|js|jsx)$/,
                loader: 'eslint-loader',
                exclude: /node_modules/,                    //处理.vue文件
                enforce: 'pre' //预处理
            },
            {
                test: /\.jsx$/,
            ...
            },
            {
                test: /\.js$/,
                loader: 'babel-loader',
                exclude: /node_modules/                  //处理js文件，忽略掉node_modules文件
            },
            {
                ...
                use: [
                    {                                   //loader是可以配置选项的,如下options
                        ...
                        options: { 
                            ...
                            name: 'resource/[path][name].[hash:8].[ext]'        //输出文件的名字,[name] 文件原名,[ext]文件扩展名.
                        }
                    }
                ]
            }
